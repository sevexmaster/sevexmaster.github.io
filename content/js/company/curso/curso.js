(function () {
    ...
    curso.curso = function (painel = null, callback = () => { }) {
        ...
        document.querySelector(".ptc")
            ...
            page.form("#curso").create({
                rules: validate,
                done: function (response) { 
                },
                controller: curso.method,
                ...
                filds: [
                    ...
                    { name: "duracao", id: "duracao", type: "text", autocomplete:"off", label: "Duração", "mensage-worning": "" },
                    { name: "codigo", id: "codigo", type: "text", autocomplete:"off", label: "Codigo", "mensage-worning": "" },
                    { name: "nivel", id: "nivel", type: "text", autocomplete:"off", label: "Nivel", "mensage-worning": "" },
                    { name: "dapartamentoId", id: "dapartamentoId", type: "text", autocomplete:"off", label: "Departamento", "mensage-worning": "" }
                ]
            }).then(resonse => {
                return reload();
            });
