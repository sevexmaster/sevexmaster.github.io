(function () {
    ...
    (page.painel || {}).departamento = {};

    var departamento = page.painel.departamento;
    ...
    departamento.departamento = function (painel = null, callback = () => { }) {
        ...
        document.querySelector(".ptc")
            ...
            page.form("#departamento").create({
                rules: validate,
                done: function (response) { 
                },
                controller: departamento.method,
                ...
                filds: [
                    ...
                    { name: "Filial", id: "Filial", type: "text", autocomplete:"off", label: "Filial", "mensage-worning": "" }
                ]
            }).then(resonse => {
                return reload();
            });
